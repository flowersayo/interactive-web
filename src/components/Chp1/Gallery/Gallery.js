...
const AsyncModal = Loadable({
  loader: () =>
    import(
      /* webpackChunkName: 'GalleryModalComponent' */ './../../Common/Modal'
    ),
  loading: Spinner,
});
        ...
        <AsyncModal isOpen={isModalOpen3a} toggle={toggleModal3a}>
          <ModalSection>
            ...
            <ModalTextContainer>
              ...
              <Divider />
              <ModalScript>
                “옛날에는 반상회도 하고 관리도 잘하고, 옛날에는 좋았어요.
                (지금은) 다 나가버렸어요. 다들 나간 줄도 모르게 나가버렸어요.”
              </ModalScript>
            </ModalTextContainer>
          </ModalSection>
        </AsyncModal>
        ...
        <AsyncModal isOpen={isModalOpen3e} toggle={toggleModal3e}>
          <ModalSection>
            ...
            <ModalTextContainer>
              ...
              <Divider />
              <ModalScript>
                "(빈집에) 노숙자들이 들어와서 술도 마셔요. 어디 사람인지도
                몰라요. 항상 겁이 나는 게, 겨울에 담배꽁초 하나라도 던지면
                빈집만 타는 게 아니라 온 동네로 불이 번지니까."
              </ModalScript>
            </ModalTextContainer>
          </ModalSection>
        </AsyncModal>
        ...
        <AsyncModal isOpen={isModalOpen2a} toggle={toggleModal2a}>
          <ModalSection>
            ...
            <ModalTextContainer>
              ...
              <Divider />
              <ModalScript>
                “옛날에 전성기를 누렸던 그런 가옥들인데, 지금 현재는 다 떠나고
                다 비어있는 거죠. 부동산 거래를 하려면 경매로만 처분이 안 될
                정도로 수요가 없어요.”
              </ModalScript>
            </ModalTextContainer>
          </ModalSection>
        ...
        <AsyncModal isOpen={isModalOpen2b} toggle={toggleModal2b}>
          <ModalSection>
            ...
            <ModalTextContainer>
              ...
              <Divider />
              <ModalScript>
                “역 앞이고 버스터미널이고 (사람이) 많이 있었는데, 익산역으로
                오면, 그때는 팥죽 장사도 있고 옆에 거리에 장사하는 사람들이 많이
                있었는데 (지금은 없어요).”
              </ModalScript>
            </ModalTextContainer>
          </ModalSection>
        ...
        <AsyncModal isOpen={isModalOpen2d} toggle={toggleModal2d}>
          <ModalSection>
            ...
            <ModalTextContainer>
              ...
              <Divider />
              <ModalScript>
                "3만 명이 안 되는 자리에 상가들이 보시다시피 너무 많이 건축이
                되다 보니까, 공실이 발생될 수 밖에 없는 거예요"
              </ModalScript>
            </ModalTextContainer>
          </ModalSection>
        </AsyncModal>
        ...
        <AsyncModal isOpen={isModalOpen1b} toggle={toggleModal1b}>
          <ModalSection>
            ...
            <ModalTextContainer>
              ...
              <Divider />
              <ModalScript>
                “매년 학생 수가 급격하게 줄고 있어요. 전교생이 10명 밖에 되지
                않아 교육과정 운영에 어려움이 있을까 큰 걱정입니다.”
              </ModalScript>
            </ModalTextContainer>
          </ModalSection>
        </AsyncModal>
